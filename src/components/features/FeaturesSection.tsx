    ...
    <section className="container px-4 py-24">
      ...
      <div className="max-w-2xl mb-20">
        <h2 className="text-5xl md:text-6xl font-normal mb-6 tracking-tight text-left">
          AI-Powered Business
          <br />
          <span className="text-gradient font-medium">Growth Solutions</span>
        </h2>
        <p className="text-lg md:text-xl text-gray-400 text-left">
          Transform your lead generation and sales process with cutting-edge AI automation designed for growing businesses.
        </p>
      </div>
